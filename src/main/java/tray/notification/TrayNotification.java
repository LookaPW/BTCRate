...
public final class TrayNotification {
    ...
    private void initTrayNotification(String title, String message, NotificationType type) {
        ...
        TrayManager.addNotification(this);
        stage.setOnHiding(event->TrayManager.removeNotification(this));
    }
    ...
    private void initStage() {
        ...
        Location location = stage.getBottomRight();
        location.setY(location.getY() - ((stage.getHeight()+2)*TrayManager.getSize()));
    ...
    public void dismiss() {
        ...
        TrayManager.removeNotification(this);
    }
